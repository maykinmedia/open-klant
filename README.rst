...
master/latest       n/a                        n/a             | Klantinteracties:
                                                                 ...
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.12.0..master>`_)
                                                               | Contactgegevens:
                                                                 ...
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.12.0..master>`_)
2.12.0              | Klantinteracties: 0.3.1  2025-08-05      | Klantinteracties:
                    | Contactgegevens: 1.1.1                     `ReDoc <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/maykinmedia/open-klant/2.11.1/src/openklant/components/klantinteracties/openapi.yaml>`_,
                                                                 ...
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.11.1..2.12.0>`_)
                                                               | Contactgegevens:
