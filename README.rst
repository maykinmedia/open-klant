...
master/latest       n/a                        n/a             | Klantinteracties:
                                                                 ...
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.17.0..master>`_)
                                                               | Contactgegevens:
                                                                 ...
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.17.0..master>`_)
2.17.0              | Klantinteracties: 0.8.0  2026-06-16      | Klantinteracties:
                    | Contactgegevens: 1.1.1                     `ReDoc <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/maykinmedia/open-klant/2.17.0/src/openklant/components/klantinteracties/openapi.yaml>`_,
                                                                 `Swagger <https://petstore.swagger.io/?url=https://raw.githubusercontent.com/maykinmedia/open-klant/2.17.0/src/openklant/components/klantinteracties/openapi.yaml>`_,
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.16.0..2.17.0>`_)
                                                               | Contactgegevens:
                                                                 `ReDoc <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/maykinmedia/open-klant/2.17.0/src/openklant/components/contactgegevens/openapi.yaml>`_,
                                                                 `Swagger <https://petstore.swagger.io/?url=https://raw.githubusercontent.com/maykinmedia/open-klant/2.17.0/src/openklant/components/contactgegevens/openapi.yaml>`_,
                                                                 (`diff <https://github.com/maykinmedia/open-klant/compare/2.16.0..2.17.0>`_)
==================  =========================  =============   ================
