...
# Dump component data
# This script is not intended for a data migration to another Open Klant instance.
...
# pg_dump also does not add related tables automatically, so `dump_data.sh klantinteracties` does not add related data from contactgegevens to the dump.


set -e

DEFAULT_APPS=(klantinteracties contactgegevens)

export PGHOST=${DB_HOST:-db}
export PGPORT=${DB_PORT:-5432}
export PGUSER=${DB_USER:-openklant}
export PGDATABASE=${DB_NAME:-openklant}
